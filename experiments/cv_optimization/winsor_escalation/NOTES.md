...
- **Runs:**
  - `runs/2026-08-03_rp_ls_133829/` — escalation without revenue-cap columns in earlier export
  - `runs/2026-08-03_rp_ls_143601/` — with `capped_by_revenue_limit` / `revenue_cut_fraction`
